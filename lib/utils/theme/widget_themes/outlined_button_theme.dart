...
class KOutlinedButtonTheme {
  ...
  static final lightOutlinedButtonTheme = OutlinedButtonThemeData(
    style: OutlinedButton.styleFrom(
      ...
      textStyle: const TextStyle(
          fontSize: 16, color: KColors.black, fontWeight: FontWeight.w600),
      padding: const EdgeInsets.symmetric(
          vertical: KSizes.buttonHeight, horizontal: 20),
  ...
  static final darkOutlinedButtonTheme = OutlinedButtonThemeData(
    style: OutlinedButton.styleFrom(
      ...
      side: const BorderSide(color: KColors.borderPrimary),
      textStyle: const TextStyle(
          fontSize: 16, color: KColors.textWhite, fontWeight: FontWeight.w600),
      padding: const EdgeInsets.symmetric(
          vertical: KSizes.buttonHeight, horizontal: 20),
      shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(KSizes.buttonRadius)),
